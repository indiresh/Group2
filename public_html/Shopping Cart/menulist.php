...
<body>
<p><a href="http://secs.oakland.edu/~rboonen/" target="_blank">Back to homepage</a></p
<h1>Menu Items List</h1>
 <dl>
  ...
  <td><a href="menulist.php?action=addItem&amp;productId=<?php echo $product->getId() ?>">Add Item</a></dd></td>
  </tr>
 </table>
 <?php } ?>
  </dl>
